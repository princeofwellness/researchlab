        ...
        en: {
            ...
            timeline: {
                ...
                intro: {
                    ...
                    speaker: "Prince",
                    topics: [
                        "It's Wednesday. 6pm. You could be anywhere. But you're here.",
                        "What connects everyone in this room isn't a title, a company, or how much you know about AI. It's curiosity. In a time when nobody knows exactly what's coming, you chose not to stand still.",
                        "Three perspectives. One story. Taste, leverage, clarity. Open Slido — QR code is on screen. Drop questions all evening, best ones get answered.",
                        "For those watching online — you're part of this. Slido works for you too.",
                        "This is Edition 01. First time. We're building this with you, not for you.",
                        "First act. Taste. Roland Vraník.",
                    ],
                    notes:
                        "The opener is the curiosity angle — names what unites the room. Not skill, not title, not AI experience. Then Slido + online in 10 seconds. Edition 01 in one sentence. Handoff to Roland — no bio, just name and topic. Total: under 3 minutes.",
                },
                roland: {
                    time: "17:05",
                    duration: "40 min",
                ...
                closing: {
                    ...
                    speaker: "Prince",
                    topics: [
                        "MONDAY ACTION: \"I don't want you to take 50 things from tonight. I want one. One thing you'll do differently tomorrow morning. Think about it now.\"",
                        "TOOLKIT: \"We recorded the whole evening. We listened to your questions. In 10 days you get a personalized toolkit — not a generic list, but something built from what YOU discussed tonight.\"",
                        "FEEDBACK + EDITION 01: \"This was Edition 01. The first one. And we need one thing from you: tomorrow you'll get a short feedback form. Three questions, one minute. What worked, what didn't, what you'd want next time. You co-created something tonight that didn't exist before. Help us make it better.\"",
                        "TEAM PITCH: \"If you're sitting here thinking 'my whole team needs this' — reach out. We do this for companies too, tailored. research@sorrywecan.com.\"",
                        "THANK YOU: Thank the speakers. Thank the audience — for their evening, their curiosity, and their trust that this matters.",
                        "OPEN: Who wants to stay, stays. Who wants to leave, leaves. Speakers are here. Networking is organic.",
                    ],
                    notes: "6 blocks in ~3 min. Monday action → Toolkit → Feedback/Edition 01 → Team pitch → Thank you → Open networking. Don't rush the thank you — let it land.",
                },
                networking: {
                    time: "20:20",
                    duration: "Open",
        ...
        sk: {
            ...
            timeline: {
                ...
                intro: {
                    ...
                    speaker: "Prince",
                    topics: [
                        "Je streda. Šesť večer. Mohli ste byť kdekoľvek. Ale ste tu.",
                        "To, čo nás tu všetkých spája, nie je pozícia, firma, ani to, koľko toho viete o AI. Je to zvedavosť. V čase, keď nikto presne nevie, čo príde, ste sa rozhodli neostať stáť.",
                        "Tri pohľady. Jeden príbeh. Vkus, využitie, jasnosť. Otvorte si Slido — QR kód vidíte na obrazovke. Hádžte otázky celý večer, najlepšie budú zodpovedané.",
                        "A pre tých z vás online — ste súčasť tohto. Slido funguje aj pre vás.",
                        "Toto je Edition 01. Prvýkrát. Staviame to s vami, nie pre vás.",
                        "Prvý akt. Vkus. Roland Vraník.",
                    ],
                    notes:
                        "Opener je zvedavosť — pomenuje to, čo spája celú miestnosť. Nie skill, nie titul, nie AI skúsenosti. Potom Slido + online za 10 sekúnd. Edition 01 v jednej vete. Handoff na Rolanda — žiadna bio, len meno a téma. Celé: pod 3 minúty.",
                },
                roland: {
                    time: "17:05",
                    duration: "40 min",
                ...
                closing: {
                    ...
                    speaker: "Prince",
                    topics: [
                        "PONDELKOVÁ AKCIA: \"Nechcem, aby ste si z dneška odniesli 50 vecí. Chcem jednu. Jednu vec, ktorú zajtra ráno urobíte inak. Premýšľajte nad ňou teraz.\"",
                        "TOOLKIT: \"Nahrali sme celý večer. Počúvali sme vaše otázky. O 10 dní dostanete personalizovaný toolkit — nie generický zoznam, ale niečo šité na to, čo ste dnes riešili vy.\"",
                        "FEEDBACK + EDITION 01: \"Toto bola Edition 01. Prvá. Zajtra vám príde krátky feedback form. Tri otázky, minúta vášho času. Čo zabralo, čo nie, čo by ste chceli nabudúce. Tým, že ste tu dnes, ste spoluvytvorili niečo, čo tu predtým nebolo. Pomôžte nám to dotiahnuť.\"",
                        "TÍMOVÝ PITCH: \"Ak dnes sedíte a hovoríte si 'toto by potreboval celý môj tím' — ozvite sa nám. Robíme toto aj pre firmy, šité na mieru. research@sorrywecan.com.\"",
                        "ĎAKUJEME: Poďakuj spíkrom. Poďakuj publiku — za ich večer, za zvedavosť a za dôveru, že to má zmysel.",
                        "OPEN: Kto chce zostať, zostáva. Kto chce ísť, ide. Spíkri sú tu. Networking je organický.",
                    ],
                    notes: "6 blokov za ~3 min. Pondelková akcia → Toolkit → Feedback/Edition 01 → Tímový pitch → Ďakujeme → Networking. Neponáhľaj ďakovanie — nechaj ho doznať.",
                },
                networking: {
                    time: "20:20",
                    duration: "Open",
