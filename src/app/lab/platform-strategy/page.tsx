                ...
                <div className="max-w-5xl mx-auto relative">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-12">
                        {[
                            ...
                            { phase: "Q3", space: "Guru AI", desc: "Tiep's thinking, frameworks, and methodologies trained as a private Claude instance. 24/7 access to RL intelligence. Scales Tiep without burning him out. 30% who use it upgrade to direct access.", moat: true },
                        ].map((s, i) => (
                ...
                <div className="max-w-5xl mx-auto relative">
                    ...
                    <div className="space-y-3 mb-12">
                        {[
                            ...
                            { tier: "General Membership", price: "€59/mo", lock: "Open enrollment", timeline: "September 2026", highlight: false, who: "Public launch. Found through content, webinars, The Radar.", what: ["Everything founding members have", "Guru AI access (Q3)", "Quarterly Premium Challenges"] },
