                    ...
                    >
                        ...
                        <div className="space-y-4">
                            <div className="flex flex-wrap gap-4">
                                ...
                                <Link href="/ideas/research-lab/journey" className="border border-black/10 px-10 py-5 font-inter font-semibold text-[11px] uppercase tracking-[0.25em] hover:bg-[#0047BB] hover:text-white hover:border-[#0047BB] transition-all flex items-center gap-2">
