...
export default function GamePlanPage() {
    ...
    return (
        <div className="min-h-screen bg-[#f5f5f3] text-[#0a0a0a] font-mono selection:bg-[#0047BB]/20">
            ...
            <section className="py-24 px-6 md:px-20 bg-black text-white border-t border-white/10">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-16">
                        <span className="text-[10px] font-bold tracking-[0.5em] uppercase text-[#0047BB] block mb-4">06</span>
                        <h2 className="font-serif-instrument text-5xl md:text-6xl tracking-tighter leading-none">
                            Financial Projections
                        </h2>
                        <p className="text-sm text-white/40 mt-4">Numbers that make this viable</p>
                    </div>
